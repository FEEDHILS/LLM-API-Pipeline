...
Перед запуском скрипта следует создать .env файл в котором указать ваш ключ модели Xiaomi MiMo в переменнную 'API_KEY'.
По необходимости замените input.csv на ваши данные и отредактируйте main.py чтоб он считывал нужную вам колонку.
